...
export default class ListController {
    ...
    constructor(AutorServico, Notification) {
    ...
    excluir(id) {
        swal({
            ...
            text: 'Deseja realmente remover o autor',
            type: 'warning',
            ...
            this.load()
            this._notify.success('Autor excluído com sucesso')
        }).catch(erro => {
...
ListController.$inject = ['AutorServico', 'Notification']
