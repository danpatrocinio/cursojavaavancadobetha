...
export default class ListController {
    ...
    constructor(EmprestimoServico, Notification) {
        ...
        this.filterValue = ''
        this.order = 'dataPrevisaoDevolucao'
        this.records = []
    ...
    excluir(id) {
        swal({
            ...
            text: 'Deseja realmente remover o empréstimo',
            type: 'warning',
            ...
            this.load()
            this._notify.success('Empréstimo excluído com sucesso')
        }).catch(erro => {
...
ListController.$inject = ['EmprestimoServico', 'Notification']
