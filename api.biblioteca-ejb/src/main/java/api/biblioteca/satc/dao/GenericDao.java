...
import api.biblioteca.satc.util.JpaCriteriaHelper;
...
public class GenericDao<T extends Entity> {
    ...
    public List<EntitySelectable> findAllToSelectableNome() {
        return em.createQuery("SELECT new api.biblioteca.satc.model.EntitySelectable(o.id, o.nome) FROM " + type.getSimpleName() + " o")
                .getResultList();
    }
